    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 ftco-animate">
                      <form method="POST" action="{{ route('process_checkout_post') }}" class="billing-form ftco-bg-dark p-3 p-md-5">
                        @csrf
              ...
              <div class="w-100"></div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="hidden" value="{{ Session::get('price') }}" name="price" class="form-control" placeholder="">
                  </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="hidden" value="{{ Auth::user()->id }}" name="user_id" class="form-control" placeholder="">
                  </div>
              </div>
              <div class="w-100"></div>
              <div class="col-md-12">
