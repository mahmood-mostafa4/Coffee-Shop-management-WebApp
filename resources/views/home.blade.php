...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url({{ asset('images/bg_1.jpg') }}); margin-top: 67px;">
      ...
      <div class="container-wrap">
          <div class="wrap d-md-flex align-items-xl-end">
              ...
              <div class="book p-4">
                ...
                @endif
                  <form action="{{ route('booking_tables') }}" method="POST" class="appointment-form">
                      @csrf
                      @if ($errors->any())
  ...
  <section class="ftco-section">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
            <div class="menu-entry">
                <a href="{{ route('single_product' , $product->id) }}" class="img" style="background-image: url({{ asset('images/'.$product->image .'') }});"></a>
            ...
            <div class="testimony">
               <blockquote>
                ...
                <div class="author d-flex mt-4">
                  <div class="name align-self-center">{{ $review->first_name }} {{ $review->last_name }}</div>
                </div>
            </div>
          </div>
          @endforeach
